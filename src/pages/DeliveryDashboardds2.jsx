        ...
        try {
            ...
            for (const item of poItems) {
                ...
                if (update) {
                    ...
                    await ep1.post('/api/v2/adddeliverydsds2', {
                        name: item.itemname,
                        user: global1.user,
                        colid: global1.colid,
            ...
            // 2. Update PO Status
            await ep1.post(`/api/v2/updatestorepoorderds2?id=${selectedPO._id}`, {
...
export default DeliveryDashboardds2;
