...
function EditRoleListds2({ open, handleClose, fetchViewPage, editUser }) {
    ...
    const handleUpdate = async () => {
        try {
            ...
            const response = await ep1.post(`/api/v2/ds1updateuser2?id=${editUser._id}`, params);
...
export default EditRoleListds2;
