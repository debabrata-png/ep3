...
import FacultyRequisitionPrintTemplate from './FacultyRequisitionPrintTemplatenew';

const FacultyCreateRequestds2new = () => {
    ...
    const generateIndentNumber = (prefix = "MRN") => {
        const now = new Date();
    ...
    useEffect(() => {
        if (selectedDeptId && userDepartments.length > 0) {
            ...
            const prefix = dept?.institutionshort ? `MRN${dept.institutionshort}` : "MRN";
            setIndentNumber(generateIndentNumber(prefix));
        } else {
            setIndentNumber(generateIndentNumber("MRN"));
        }
                                    ...
                                    <FormControl fullWidth size="small" required error={!selectedDeptId}>
                                        ...
                                        {userDepartments.length === 0 && (
                                            <Typography variant="caption" color="error" sx={{ px: 2 }}>
                                                Ask admin to configure your department in 'Department MRN'
                                            </Typography>
                                        )}
                                    </FormControl>
                                </Grid>
...
export default FacultyCreateRequestds2new;
