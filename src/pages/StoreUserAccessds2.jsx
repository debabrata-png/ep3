...
const StoreUserAccessds2 = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const userRes = await ep1.post('/api/v2/getallusers2', { colid: global1.colid });
    ...
    const handleAddMapping = async () => {
        ...
        try {
            ...
            await ep1.post('/api/v2/addstoreuserds2', payload);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await ep1.get(`/api/v2/deletestoreuserds2?id=${id}`);
            fetchData();
        } catch (error) {
...
export default StoreUserAccessds2;
