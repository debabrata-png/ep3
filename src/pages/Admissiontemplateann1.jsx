  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.status === 201 || res.status === 200) {
        alert("Application Submitted Successfully! Your PDF is generating...");

        // 5. Trigger PDF Download
        await downloadPDF();

        // 6. Navigate away only after success
        navigate("/success");
      }
    } catch (err) {
      ...
      <Box ref={printRef}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {step === 3 && (
              <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
                ...
                <FormField
                  label="Caste / Religion / Nationality"
                  name="caste"
        ...
        <Box sx={{ position: "absolute", left: "-10000px", top: 0 }}>
          ...
          >
            ...
            >
              <Typography sx={{ fontWeight: "bold" }}>Sl. No.</Typography>
              <Typography
                variant="h6"
                sx={{
                  fontWeight: "bold",
            ...
            <Box sx={{ mt: 1, fontSize: "12px" }}>
              ...
              <Typography sx={{ mt: 1 }}>
                7. Caste / Religion / Nationality : <b>{formData.caste}</b>
              </Typography>
              <Typography sx={{ mt: 1 }}>
                8. Aadhar No : <b>{formData.aadhaarNumber}</b>
              </Typography>
              <Typography sx={{ mt: 1 }}>
                9. Name & Address of the last Attended School :{" "}
          ...
          >
            <Box sx={{ fontSize: "13px" }}>
              <Box sx={{ display: "flex", gap: 4, mb: 1 }}>
                <Typography>
                  10. Class Last Attended : <b>{formData.classLastattended}</b>
                </Typography>
                <Typography>
                  11. Dise code / STS No. : <b>{formData.diseCode}</b>
                </Typography>
              </Box>
              <Typography>12. Last School affiliated is :</Typography>
              <Typography sx={{ ml: 2 }}>
                (i) CBSE [{" "}
              ...
              <Typography sx={{ mt: 2 }}>13. Result of last class :</Typography>
              ...
              <Typography>
                14. Transfer Certificate No. :{" "}
                <b>{formData.transfercertificateNum}</b>
              </Typography>
              <Typography sx={{ ml: 4 }}>
                Date of Issue : <b>{formData.dateOfissue}</b>
              </Typography>

              <Typography sx={{ mt: 2 }}>
                15. Details of Siblings (if any)
              </Typography>
              <TableContainer sx={{ border: "1px solid #000", mt: 1 }}>
                <Table size="small">
                  <TableHead>
              ...
              <Typography sx={{ mt: 2 }}>
                16. Mother Tongue : <b>{formData.motherToungue}</b>
              </Typography>
