...
const POInvoiceTemplate2 = ({ poData, poItems, vendorData, instName, instAddress, instPhone, instShortName, isAmendment, notes, terms }) => {
...
export default POInvoiceTemplate2;
