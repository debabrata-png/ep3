...
{open && <ListItemText primaryTypographyProps={{fontSize: "14px"}} primary="AI Chatbot" />}
       ...
       */}
          ...
          <ListItem button component={RouterLink} to="/studentlistds">
            <ListItemIcon>
              <PersonIcon />
            </ListItemIcon>
            {open && <ListItemText primaryTypographyProps={{ fontSize: "14px" }} primary="Students List" />}
          </ListItem>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          ...
          <ListItem button component={RouterLink} to="/admissionreport">
            ...
            {open && <ListItemText primaryTypographyProps={{ fontSize: '14px' }} primary="Admission Report" />}
          </ListItem>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          ...
          <ListItem button component={RouterLink} to="/usermanagementdsnov17">
            ...
            {open && <ListItemText primaryTypographyProps={{ fontSize: "14px" }} primary="User management" />}
          </ListItem>
