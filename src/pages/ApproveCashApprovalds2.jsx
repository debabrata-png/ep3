...
const ApproveCashApprovalds2 = () => {
    ...
    const fetchRequests = async () => {
        ...
        try {
            ...
            const res = await ep1.get(`/api/v2/cashapproval2?colid=${global1.colid}`);
    ...
    const handleApprove = async (id) => {
        ...
        try {
            const res = await ep1.post(`/api/v2/cashapproval2/approve`, {
                id: id,
...
export default ApproveCashApprovalds2;
