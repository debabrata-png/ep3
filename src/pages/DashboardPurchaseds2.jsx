...
const DashboardPurchaseds2 = () => {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            color: "#c2185b", // Pink
            path: "/FacultyRequestApprovalds2"
        },
        {
        ...
        },
        {
            ...
            path: "/ImprestManagerds2" // Direct link to Imprest Manager
        }
    ];
...
export default DashboardPurchaseds2;
