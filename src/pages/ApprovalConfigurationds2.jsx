...
const ApprovalConfigurationds2 = () => {
    ...
    const handleAddOrUpdateStep = async () => {
        ...
        try {
            if (isEditMode && editStepId) {
                await ep1.post('/api/v2/updateapprovalconfig2', {
                    id: editStepId,
                ...
                await ep1.post('/api/v2/addapprovalconfig2', {
                    colid: global1.colid,
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await ep1.get(`/api/v2/deleteapprovalconfig2?id=${id}`);
...
export default ApprovalConfigurationds2;
