        ...
        <div style={{ overflowY: 'scroll', height: 600, width: 300, fontSize: 10 }}>
            <Accordion>
                <AccordionSummary aria-controls="panel3-content" id="panel3-header">
                    ...
                    {open && <Typography sx={{ fontSize: 14 }}>AHOI Approval</Typography>}
                </AccordionSummary>
                <AccordionDetails>
                    <ListItem button component={RouterLink} to="/role/faculty-request-approval2">
                        ...
                        {open && <ListItemText primaryTypographyProps={{ fontSize: "14px" }} primary="Requisition Approval" />}
                    </ListItem>
                </AccordionDetails>
            </Accordion>
