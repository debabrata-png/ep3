...
import OEPRAssignmentsds2 from './OEPRAssignmentsds2';
import ImprestManagerds2 from './ImprestManagerds2';
import PurchaseOrderDashboardds2 from './PurchaseOrderDashboardNewds2';
import AssignmentIcon from '@mui/icons-material/Assignment';
import ShoppingCartIcon from '@mui/icons-material/ShoppingCart';
import AccountBalanceWalletIcon from '@mui/icons-material/AccountBalanceWallet';
import global1 from './global1';

const OEDashboardds2 = () => {
    ...
    return (
        <Box sx={{ width: '100%', minHeight: '100vh', backgroundColor: '#f4f6f8' }}>
            ...
            <Box p={3}>
                {value === 0 && <PurchaseOrderDashboardds2 role="OE" />}
                {value === 1 && <ImprestManagerds2 />}
            </Box>
        </Box>
    );
};

export default OEDashboardds2;
