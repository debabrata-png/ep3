...
const PRTemplate2 = ({ requestData, items, prNumber, instituteName, instituteAddress, institutePhone, createdByName }) => {
    ...
    return (
        <Box sx={{
            ...
            <div className="print-container">
                ...
                <div className="center-text mb-2">
                    <div className="bold-text" style={{ fontSize: '1.2rem', textDecoration: 'underline' }}>Indent</div>
                </div>

                {/* PR Details - Centered PR Number Row */}
                <div className="center-text mb-2 mt-4">
                    <span className="bold-text" style={{ marginRight: '10px' }}>Indent Number :</span>
                ...
                <div className="flex-row mb-2">
                    <span className="bold-text" style={{ width: '100px' }}>Indent Date :</span>
