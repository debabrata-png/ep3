...
const Vendormanagementds2 = () => {
  ...
  const handleUpdate = async () => {
    try {
      await ep1.post(`/api/v2/updatevendords2?id=${editId}`, formData);
  ...
  const handleBulkUpload = (e) => {
    ...
    reader.onload = async (event) => {
      try {
        ...
        await ep1.post("/api/v2/bulkaddvendords2", { vendors: vendorsArray });
...
export default Vendormanagementds2;
