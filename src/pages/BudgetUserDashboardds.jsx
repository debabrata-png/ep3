...
const BudgetUserDashboardds = () => {
    ...
    const fetchBudgets = async () => {
        try {
            ...
            const userItems = items.filter(b => b.user === global1.user);
            setBudgets(userItems.map(i => ({ ...i, id: i._id })));
        } catch (e) { console.error(e); }
    };
    ...
    return (
        <Box p={3}>
            <Typography variant="h5" gutterBottom>User Budget Dashboard</Typography>
...
export default BudgetUserDashboardds;
