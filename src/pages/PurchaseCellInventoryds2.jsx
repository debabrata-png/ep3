...
const PurchaseCellInventoryds2 = () => {
    ...
    const fetchInventory = async () => {
        try {
            ...
            } else if (items.storeItems && Array.isArray(items.storeItems)) {
                normalizedItems = items.storeItems;
            } else if (res.data.storeItems && Array.isArray(res.data.storeItems)) {
                normalizedItems = res.data.storeItems;
            }

            setInventory(normalizedItems.map(i => ({ ...i, id: i._id })));
    ...
    const columns = [
        ...
        { field: 'colid', headerName: 'College ID', width: 100 }, // Added colid column
        { field: 'user', headerName: 'User', width: 150 }, // Replaced user2 with user
        {
    ...
    const handleExport = () => {
        ...
        // Replaced 'user2' with 'user' in unwantedFields
...
export default PurchaseCellInventoryds2;
