...
export function menuitemsallold() {
  const open = true;
  return (
      ...
      <Accordion>
        ...
        <AccordionDetails>
          ...
          <ListItem button component={RouterLink} to="/programwisependingreportds">
            ...
            {open && <ListItemText primaryTypographyProps={{ fontSize: '14px' }} primary="Programwise Pending new" />}
          </ListItem>
...
{open && <ListItemText primaryTypographyProps={{fontSize: "14px"}} primary="Navigate" />}
      ...
      <Accordion>
        <AccordionSummary aria-controls="panelU-content" id="panelU-header">
          <SettingsIcon sx={{ marginRight: 1 }} />
          {open && <Typography sx={{ fontSize: 14 }}>Universal Gateway Integration</Typography>}
        </AccordionSummary>
        <AccordionDetails>
