...
const StoreGatePassds2 = () => {
    ...
    const fetchStores = async () => {
        try {
            const res = await ep1.get(`/api/v2/getallstoreds2?colid=${global1.colid}`);
    ...
    const historyColumns = [
        ...
        { field: 'createdAt', headerName: 'Date', width: 160, valueFormatter: (p) => new Date(p.value).toLocaleString() },
