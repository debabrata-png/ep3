...
const StaffProfileds2 = () => {
    ...
    const fetchProfile = async () => {
        try {
            const res = await ep1.get("/api/v2/ds1getstudentprofile2", {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await ep1.post("/api/v2/ds1updatestudentprofile2", formData, {
                params: { email: global1.user }
            });
...
export default StaffProfileds2;
